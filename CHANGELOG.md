...
- use Prettier during codegen when a legacy `codegen.prettier` config is present.
- include Prettier in the development Docker image for legacy codegen formatting.
