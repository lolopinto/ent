...
- generate reversible migrations when an existing index's partial predicate
  changes, and preserve literal percent signs in generated index migrations (#2028).
