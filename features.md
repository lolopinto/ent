...
| ints          | :heavy_check_mark: |                    | :heavy_check_mark: |
...
| [assoc group](#assoc-group)                                                                                                       | :heavy_check_mark: |                    | :heavy_check_mark: |
...
| Functionality                        | Go                 | Typescript | MVP                |
|--------------------------------------|--------------------|------------|--------------------|
| base case (everything)               | :heavy_check_mark: |            | :heavy_check_mark: |
...
| Functionality                              | Go                 | Typescript         | MVP                |
|--------------------------------------------|--------------------|--------------------|--------------------|
| custom actions (schema)                    | :heavy_check_mark: |                    | :heavy_check_mark: |
