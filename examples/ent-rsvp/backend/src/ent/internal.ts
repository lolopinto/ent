...
export * from "src/ent/event_activity/query/owners_from_event_activity_to_addresses_query";
...
export * from "src/ent/user/query/owners_from_user_to_addresses_query";
