...
} from "../ent/place_review/actions/create_place_review_action.js";
import { PlaceCategory } from "../ent/generated/types.js";
...
describe("local guide nearby search integration", () => {
  dbTest(
    "creates places with reviews and favorites, then loads nearby places",
    async () => {
      ...
      const farCenter = geoPoint(
        center.longitude + 0.03,
        center.latitude + 0.03,
      );
