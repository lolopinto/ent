...
import {EntNodeResolver, GraphQLNodeInterface, registerResolver, resolveID} from "@snowtop/ent/graphql";
...
resolve: async (_source, args: NodeQueryArgs, context:RequestContext<Viewer>, _info: GraphQLResolveInfo) => {
