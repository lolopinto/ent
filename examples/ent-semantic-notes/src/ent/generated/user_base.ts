...
import { userEmailAddressLoader, userLoader, userLoaderInfo } from "./loaders";
...
export class UserBase implements Ent<Viewer> {
  ...
  queryCreatedWorkspaces(): UserToCreatedWorkspacesQuery {
    return UserToCreatedWorkspacesQuery.query(this.viewer, this.id);
  }

  queryNotesAuthored(): UserToNotesAuthoredQuery {
    return UserToNotesAuthoredQuery.query(this.viewer, this.id);
  }

  querySavedNotes(): UserToSavedNotesQuery {
    return UserToSavedNotesQuery.query(this.viewer, this.id);
  }

  queryWorkspaces(): UserToWorkspacesQuery {
    return UserToWorkspacesQuery.query(this.viewer, this.id);
  }
}
