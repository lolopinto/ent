...
sa.Table("contacts", metadata,
         ...
         sa.ForeignKeyConstraint(
             ["user_id"], ["users.id"], name="contacts_user_id_fkey", ondelete="CASCADE"),
         )
...
sa.Table("event_hosts_edges", metadata,
         ...
         sa.PrimaryKeyConstraint(
             "id1", "edge_type", "id2", name="event_hosts_edges_id1_edge_type_id2_pkey"),
...
sa.Table("event_rsvps_edges", metadata,
         ...
         sa.Column("data", sa.Text(), nullable=True),
         sa.PrimaryKeyConstraint(
             "id1", "edge_type", "id2", name="event_rsvps_edges_id1_edge_type_id2_pkey"),
...
sa.Table("object_likers_edges", metadata,
         ...
         sa.Column("data", sa.Text(), nullable=True),
         sa.PrimaryKeyConstraint(
             "id1", "edge_type", "id2", name="object_likers_edges_id1_edge_type_id2_pkey"),
...
sa.Table("user_created_events_edges", metadata,
         ...
         sa.Column("data", sa.Text(), nullable=True),
         sa.PrimaryKeyConstraint(
             "id1", "edge_type", "id2", name="user_created_events_edges_id1_edge_type_id2_pkey"),
...
sa.Table("user_friends_edges", metadata,
         ...
         sa.Column("data", sa.Text(), nullable=True),
         sa.PrimaryKeyConstraint(
             "id1", "edge_type", "id2", name="user_friends_edges_id1_edge_type_id2_pkey"),
...
sa.Table("user_self_contact_edges", metadata,
         ...
         sa.Column("data", sa.Text(), nullable=True),
         sa.PrimaryKeyConstraint(
             "id1", "edge_type", "id2", name="user_self_contact_edges_id1_edge_type_id2_pkey"),
         sa.Index("user_self_contact_edges_time_idx", "time"),
         sa.UniqueConstraint(
             "id1", "edge_type", name="user_self_contact_edges_unique_id1_edge_type"),
         )
...
sa.Table("users", metadata,
         ...
         sa.Column("preferred_shift", postgresql.ARRAY(
             sa.Text()), nullable=True),
         sa.Column("time_in_ms", sa.BigInteger(), nullable=True),
         sa.Column("fun_uuids", postgresql.ARRAY(
