...
def downgrade():
    ...
    op.modify_edge(
        '8caba9c4-8035-447f-9eb1-4dd09a2d250c',
        {'edge_type': UUID('8caba9c4-8035-447f-9eb1-4dd09a2d250c'), 'edge_name': 'ObjectToCommentsEdge', 'symmetric_edge': False,
         'inverse_edge_type': UUID('4b725578-e9f5-472c-8e57-e47481c9e1b8'), 'edge_table': 'object_comments_edges'},
