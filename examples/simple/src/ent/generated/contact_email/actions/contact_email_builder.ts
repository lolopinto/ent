...
import { Contact, ContactEmail, User } from "../../../index.js";
import { contactEmailLoaderInfo } from "../../loaders.js";
  ...
  implements Builder<ContactEmail, ExampleViewerAlias, TExistingEnt>
{
  ...
  addEmailsForContact(
    ...
    for (const node of nodes) {
      if (this.isBuilder(node)) {
        this.addEmailsForContactID(node);
      } else if (typeof node === "object") {
        this.addEmailsForContactID(node.id);
      } else {
        this.addEmailsForContactID(node);
      }
    }
  ...
  removeEmailsForContact(...nodes: (ID | Contact)[]): this {
    for (const node of nodes) {
