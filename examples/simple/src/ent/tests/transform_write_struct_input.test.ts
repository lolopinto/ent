...
import { NotifType } from "../generated/types.js";
import CreateUserAction, {
  type UserCreateInput,
} from "../user/actions/create_user_action.js";
import type { UserBuilder } from "../generated/user/actions/user_builder.js";
import { LoggedOutExampleViewer } from "../../viewer/viewer.js";
import { random, randomEmail, randomPhoneNumber } from "../../util/random.js";

test.skip("transformWrite keeps generated struct list input in trigger shape", async () => {
