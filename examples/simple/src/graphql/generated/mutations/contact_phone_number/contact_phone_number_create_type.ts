...
import type { ContactPhoneNumberCreateInput } from "../../../../ent/contact_phone_number/actions/create_contact_phone_number_action.js";
...
> = {
  get type() {
    return new GraphQLNonNull(ContactPhoneNumberCreatePayloadType);
  },
  args: {
    input: {
      description: "",
