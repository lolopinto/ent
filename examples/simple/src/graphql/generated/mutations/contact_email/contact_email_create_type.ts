...
import type { ContactEmailCreateInput } from "../../../../ent/contact_email/actions/create_contact_email_action.js";
...
> = {
  get type() {
    return new GraphQLNonNull(ContactEmailCreatePayloadType);
  },
  args: {
    input: {
      description: "",
