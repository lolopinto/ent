...
import type { ContactEditInput } from "../../../../ent/contact/actions/edit_contact_action.js";
...
> = {
  get type() {
    return new GraphQLNonNull(ContactEditPayloadType);
  },
  args: {
    input: {
      description: "",
