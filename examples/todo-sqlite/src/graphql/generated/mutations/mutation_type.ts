...
import { AccountTransferCreditsType } from "src/graphql/generated/mutations/account/account_transfer_credits_type";
import { AccountUpdateBalanceType } from "src/graphql/generated/mutations/account/account_update_balance_type";
...
import { ChangeTodoBountyType } from "src/graphql/generated/mutations/todo/change_todo_bounty_type";
...
export const MutationType = new GraphQLObjectType({
  name: "Mutation",
  fields: () => ({
    accountTransferCredits: AccountTransferCreditsType,
    accountUpdateBalance: AccountUpdateBalanceType,
    addTodoTag: AddTodoTagType,
    changeTodoBounty: ChangeTodoBountyType,
