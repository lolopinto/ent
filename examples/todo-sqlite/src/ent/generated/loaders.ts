...
export const accountLoader = new ObjectLoaderFactory({
  ...
  key: "id",
  clause: getTransformedReadClause(Account),
});
...
export const tagLoader = new ObjectLoaderFactory({
  ...
  fields: tagFields,
  key: "id",
  clause: getTransformedReadClause(Tag),
});
...
export const todoLoader = new ObjectLoaderFactory({
  ...
  fields: todoFields,
  key: "id",
  clause: getTransformedReadClause(Todo),
});
