...
// func TestParseInputWithForeignKeyHiddenFromGraphQL(t *testing.T) {
// 	inputSchema := &input.Schema{
// 		Nodes: map[string]*input.Node{
// 			"User": {
// 				Fields: []*input.Field{
...
// 							DBType: input.UUID,
// 						},
// 						ForeignKey: &input.ForeignKey{Schema: "UserPrefs", Column: "id", Name: "prefs"},
// 						Index:      true,
// 					},
// 				},
// 			},
...
// 							DBType: input.UUID,
// 						},
// 						ForeignKey: &input.ForeignKey{Schema: "User", Column: "id", Name: "user_prefs_edge"},
// 						Index:      true,
// 					},
// 				},
// 			},
...
// 	userPrefs := schema.Nodes["UserPrefs"]
// 	assert.NotNil(t, userPrefs)
// 	assert.False(t, userPrefs.NodeData.HideFromGraphQL)

// 	userEdge := userPrefs.NodeData.EdgeInfo.GetFieldEdgeByName("User")
// 	assert.NotNil(t, userEdge)

// 	user := schema.Nodes["User"]
// 	assert.NotNil(t, user)

// 	spew.Dump(user.NodeData.EdgeInfo)
// 	userPrefsEdge := user.NodeData.EdgeInfo.GetFieldEdgeByName("UserPrefs")
// 	assert.NotNil(t, userPrefsEdge)

// 	// hide from graphql
// 	inputSchema.Nodes["UserPrefs"].HideFromGraphQL = true
...
// 	userPrefs = schema.Nodes["UserPrefs"]
// 	assert.NotNil(t, userPrefs)
// 	assert.True(t, userPrefs.NodeData.HideFromGraphQL)
