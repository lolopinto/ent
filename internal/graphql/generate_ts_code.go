...
func (cs *CustomScalarInfo) getRenderer() renderer {
...
func (r *gqlRootData) getRenderer() renderer {
	return &elemRenderer{
		name:   r.Node,
		fields: r.fieldTypes,
	}
...
func generateAlternateSchemaFile(processor *codegen.Processor, s *gqlSchema) error {
	...
	writeRenderer := func(r renderable) {
		sb.WriteString(r.getRenderer().render(s))
		sb.WriteString("\n")
	}
