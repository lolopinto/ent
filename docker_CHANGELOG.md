...
- enable SQLite codegen in arm64 images by cross-compiling tsent with its C
  dependency enabled. Includes tsent v0.3.10 and auto_schema 0.0.41 (#2045).
...
- release Docker v0.3.10 with tsent v0.3.9 and auto_schema 0.0.41 (#2042).

### Fixed

- generate builders that distinguish computed internal defaults from explicit
  edits, preserving no-op updates. Use with `@snowtop/ent` 0.2.15 and regenerate
  existing builders (#2041).

## [0.3.9]

### Changed

- release Docker image v0.3.9 with auto_schema 0.0.41 and tsent v0.3.8 (#2037).
...
- release Docker image v0.3.7 with auto_schema 0.0.39 and tsent v0.3.6 (#2015).
...
- release Docker image v0.3.6 with auto_schema 0.0.38 and tsent v0.3.6 (#2010)

## [0.3.5]

### Changed

- release Docker image v0.3.5 with auto_schema 0.0.37 and tsent v0.3.6 (#2005)
...
- update auto_schema to 0.0.36 and tsent to v0.3.4 with Alembic 1.18.4 and SQLAlchemy 2.0.49 (#1989)
