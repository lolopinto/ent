...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => /* binding */ Event\n/* harmony export */ });\n/* harmony import */ var ent_schema__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ent/schema */ \"../../src/schema.ts\");\n/* harmony import */ var ent_field__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ent/field */ \"../../src/field.ts\");\n\n\n/// explicit schema\nclass Event extends ent_schema__WEBPACK_IMPORTED_MODULE_0__.BaseEntSchema {\n    constructor() {\n        super(...arguments);\n        this.fields = [\n            (0,ent_field__WEBPACK_IMPORTED_MODULE_1__.StringType)({ name: \"name\" }),\n            // TODO this should be an id type...\n            // we should warn when we see an \"ID/id/Id\" field as non-id type and ask if they wanna change it\n            (0,ent_field__WEBPACK_IMPORTED_MODULE_1__.StringType)({\n                name: \"creatorID\",\n                fieldEdge: [\"User\", \"createdEvents\"],\n                storageKey: \"user_id\",\n            }),\n            (0,ent_field__WEBPACK_IMPORTED_MODULE_1__.TimeType)({ name: \"start_time\" }),\n            (0,ent_field__WEBPACK_IMPORTED_MODULE_1__.TimeType)({ name: \"end_time\", nullable: true }),\n            (0,ent_field__WEBPACK_IMPORTED_MODULE_1__.StringType)({ name: \"location\" }),\n        ];\n        this.edges = [\n            {\n                name: \"hosts\",\n                schemaName: \"User\",\n            },\n            {\n                name: \"rsvps\",\n                groupStatusName: \"rsvpStatus\",\n                assocEdges: [\n                    {\n                        name: \"invited\",\n                        schemaName: \"User\",\n                        inverseEdge: {\n                            name: \"invitedEvents\",\n                        },\n                    },\n                    {\n                        // yes\n                        name: \"attending\",\n                        schemaName: \"User\",\n                        inverseEdge: {\n                            name: \"eventsAttending\",\n                        },\n                    },\n                    {\n                        // no\n                        name: \"declined\",\n                        schemaName: \"User\",\n                        inverseEdge: {\n                            name: \"declinedEvents\",\n                        },\n                    },\n                    {\n                        // maybe\n                        name: \"maybe\",\n                        schemaName: \"User\",\n                        inverseEdge: {\n                            name: \"maybeEvents\",\n                        },\n                    },\n                ],\n            },\n        ];\n        // create, edit, delete\n        this.actions = [\n            {\n                operation: ent_schema__WEBPACK_IMPORTED_MODULE_0__.ActionOperation.Mutations,\n            },\n        ];\n    }\n}\n\n\n//# sourceURL=webpack:///./src/schema/event.ts?");
...
/******/ 	__webpack_require__("./src/schema/event.ts");
/******/ })()
;