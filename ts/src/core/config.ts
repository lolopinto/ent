...
import { setClauseLoaderConcurrency } from "./loaders/object_loader.js";
import { setLoaderMaxBatchSize } from "./loaders/loader.js";
...
export interface ConfigWithCodegen extends Omit<Config, "devSchema"> {
  // module format generated by codegen. Runtime Ent is always native ESM,
  // while modern Node can synchronously require the same module graph.
...
interface CodegenConfig {
  ...
  // legacy Prettier formatting. prefer biome.json or biome.jsonc in the project root.
